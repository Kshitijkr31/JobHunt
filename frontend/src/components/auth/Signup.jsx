        ...
        >
          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-1'>
              <Label className='ml-6'>Profile</Label>
              <Input
                accept='image/*'
                type='file'
                onChange={changeFileHandler}
                className='cursor-pointer  bg-[#8c8cf2] hover:bg-[#62fffa] text-black'
                variant='outline'
              />
            </div>
          </div>
          ...
          <span className='text-sm '>
            ...
            <Link to='/login' className='text-blue-600'>
              <Button
                type='submit'
                variant='outline'
                className='w-20 my-4 ml-[4rem] bg-[#4040e8] hover:bg-[#62fffa] text-white outline-black'
              >
                Login
              </Button>
            </Link>
