...
const Profile = () => {
    ...
    return (
        <div>
            <Navbar />
             <div className='w-[53.5rem] mx-auto bg-white border ml-[21.5rem] mt-[5rem] border-gray-600 rounded-2xl  p-8'>
                <div className='flex justify-between'>
                    ...
                    className="text-right hover:origin-center transition-transform transform hover:scale-125 active:scale-150" variant="outline"><Pen /></Button>
                </div>
                <div className='my-5'>
                ...
                <div className='grid justify-center w-full max-w-sm items-center gap-1.5'>
                    <Label className="text-md font-bold ml-[-12rem]">Resume</Label>
                </div>
                {
                        isResume ? 
                        <a
                ...
                <div className='max-w-4xl mx-auto bg-white rounded-2xl ml-[21.5rem]'>
