...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 ml-20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 ml-8" >
            <h2 className="text-xl font-bold">Job<span className='text-[#1b02f8]'>Hunt -</span>  <span className='text-[#F83002]'>Navigate Your Career Path.</span></h2>
            <p className="text-sm">© 2024  All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0 ml-[50rem]">
